...
import com.solvd.laba.hospital.dao.repository.info.impl.AllergyRepositoryMybatisImpl;
...
public class AllergyServiceImpl extends InfoService implements AllergyService {
    ...
    private final AllergyRepository allergyRepository = new AllergyRepositoryMybatisImpl();
