...
import com.solvd.laba.hospital.dao.repository.info.impl.HospitalizationRepositoryMybatisImpl;
...
public class HospitalizationServiceImpl extends InfoService implements HospitalizationService {
    ...
    private final HospitalizationRepository hospitalizationRepository = new HospitalizationRepositoryMybatisImpl();
