...
import com.solvd.laba.hospital.dao.repository.appointment.impl.ConclusionRepositoryImpl;
...
public class ConclusionServiceImpl implements ConclusionService {
    ...
    private final ConclusionRepository conclusionRepository = new ConclusionRepositoryImpl();
