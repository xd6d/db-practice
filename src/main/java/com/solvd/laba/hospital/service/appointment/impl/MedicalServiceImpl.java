...
import com.solvd.laba.hospital.dao.repository.appointment.impl.MedicalRepositoryImpl;
...
public class MedicalServiceImpl implements MedicalService {
    ...
    private final MedicalRepository medicalRepository = new MedicalRepositoryImpl();
